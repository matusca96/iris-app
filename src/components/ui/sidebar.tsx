...
const setSidebarStateCookie = (openState: boolean): void => {
	...
	cookieStore
		...
		.catch(() => {
			// Best-effort persistence; ignore Cookie Store API write failures.
		});
};
...
const sidebarMenuButtonVariants = cva(
	"peer/menu-button group/menu-button flex w-full items-center gap-2 overflow-hidden rounded-md border border-transparent p-2 text-left text-sm outline-hidden ring-sidebar-ring transition-[width,height,padding] not-data-[active]:hover:bg-sidebar-accent not-data-[active]:hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent/80 active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 group-has-data-[sidebar=menu-action]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-active:border-chart-5 data-active:bg-chart-5/30 data-active:font-medium data-active:text-primary not-data-[active]:data-open:hover:bg-sidebar-accent not-data-[active]:data-open:hover:text-sidebar-accent-foreground group-data-[collapsible=icon]:size-8! group-data-[collapsible=icon]:p-2! dark:data-active:text-chart-1 [&>span:last-child]:truncate [&_svg]:size-4 [&_svg]:shrink-0",
	{
		variants: {
			variant: {
				default:
				...
				outline:
					"bg-background shadow-[0_0_0_1px_hsl(var(--sidebar-border))] not-data-[active]:hover:bg-sidebar-accent not-data-[active]:hover:text-sidebar-accent-foreground not-data-[active]:hover:shadow-[0_0_0_1px_hsl(var(--sidebar-accent))]",
			},
			size: {
				default: "h-8 text-sm",
				sm: "h-7 text-xs",
...
function SidebarMenuButton({
	...
	const comp = useRender({
		...
		render: tooltip ? <TooltipTrigger delay={200} render={render} /> : render,
		state: {
